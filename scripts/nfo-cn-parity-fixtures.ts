...
const WEAPON_SHOOTER_CASE_SPECS: WeaponShooterCaseSpec[] = [
  ...
  {
    id: "weapon-shooter-night-blade-initial-cross-lv8",
    weaponId: 28,
    weaponLevel: 8,
    shooterId: 9,
    bulletTypeId: 24,
    ...
    expectedDirectionOffsetAngle: 0,
  },
  {
...
const WEAPON_DIRECT_FIRE_CASE_SPECS: WeaponDirectFireCaseSpec[] = [
  ...
  {
    id: "weapon-direct-night-blade-dot-and-shooter-lv8",
    weaponId: 28,
    weaponLevel: 8,
    bulletTypeId: 5,
    expectedDirectFireBulletCount: 1,
...
const WEAPON_MINION_CASE_SPECS: WeaponMinionCaseSpec[] = [
  ...
  },
  {
    ...
    expectedMinionId: 10,
    expectedMinionCount: 1,
    expectedSpawnMinionAITypeId: 112,
    expectedSpawnMinionFormation: 1,
    expectedSpawnRadiusMin: 4,
    expectedSpawnRadiusMax: 5,
    expectedAIStateShooterId: 15002,
    expectedAIStateShooterBulletTypeId: 99,
    expectedAIStateShooterBulletSize: 600,
    expectedAIStateShooterHitBuffId: 120,
  },
  {
    ...
    expectedMinionId: 10,
    expectedMinionCount: 1,
    expectedSpawnMinionAITypeId: 113,
    expectedSpawnMinionFormation: 1,
    expectedSpawnRadiusMin: 4,
    expectedSpawnRadiusMax: 5,
    expectedAIStateShooterId: 15003,
    expectedAIStateShooterBulletTypeId: 99,
    expectedAIStateShooterBulletSize: 650,
    expectedAIStateShooterHitBuffId: 120,
  },
  {
    ...
    expectedMinionId: 10,
    expectedMinionCount: 1,
    expectedSpawnMinionAITypeId: 114,
    expectedSpawnMinionFormation: 1,
    expectedSpawnRadiusMin: 4,
    expectedSpawnRadiusMax: 5,
    expectedAIStateShooterId: 15004,
    expectedAIStateShooterBulletTypeId: 99,
    expectedAIStateShooterBulletSize: 700,
    expectedAIStateShooterHitBuffId: 120,
  },
  {
    ...
    expectedMinionId: 10,
    expectedMinionCount: 1,
    expectedSpawnMinionAITypeId: 115,
    expectedSpawnMinionFormation: 1,
    expectedSpawnRadiusMin: 4,
    expectedSpawnRadiusMax: 5,
    expectedAIStateShooterId: 15005,
    expectedAIStateShooterBulletTypeId: 99,
    expectedAIStateShooterBulletSize: 750,
    expectedAIStateShooterHitBuffId: 120,
  },
  {
    ...
    expectedMinionId: 10,
    expectedMinionCount: 1,
    expectedSpawnMinionAITypeId: 116,
    expectedSpawnMinionFormation: 1,
    expectedSpawnRadiusMin: 4,
    expectedSpawnRadiusMax: 5,
    expectedAIStateShooterId: 15006,
    expectedAIStateShooterBulletTypeId: 99,
    expectedAIStateShooterBulletSize: 800,
    expectedAIStateShooterHitBuffId: 120,
  },
  {
    ...
    expectedMinionId: 10,
    expectedMinionCount: 1,
    expectedSpawnMinionAITypeId: 117,
    expectedSpawnMinionFormation: 1,
    expectedSpawnRadiusMin: 4,
    expectedSpawnRadiusMax: 5,
    expectedAIStateShooterId: 15007,
    expectedAIStateShooterBulletTypeId: 99,
    expectedAIStateShooterBulletSize: 850,
    expectedAIStateShooterHitBuffId: 120,
  },
];
...
const ACTIVE_SKILL_SHOOTER_SPAWN_CASE_SPECS: ActiveSkillShooterSpawnCaseSpec[] = [
  ...
  },
  {
    ...
    expectedBulletAttack: 30,
    expectedBulletSize: 30,
  },
  {
    id: "active-skill-elemental-burst-fan-fireballs-lv2",
    activeSkillId: 13,
    activeSkillLevel: 2,
    expectedEventFrame: 1,
    expectedShooterId: 13001,
    expectedSpawnPos: 3,
    expectedBulletTypeId: 11,
    expectedIsLoopEvent: true,
    expectedLoopFrameInterval: 15,
  ...
  {
    id: "active-skill-elemental-burst-fan-fireballs-lv3",
    activeSkillId: 13,
    activeSkillLevel: 3,
    expectedEventFrame: 1,
    expectedShooterId: 13002,
    expectedSpawnPos: 3,
    expectedBulletTypeId: 11,
    expectedIsLoopEvent: true,
    expectedLoopFrameInterval: 15,
    expectedBulletAttack: 80,
    expectedBulletSize: 30,
  },
  {
    ...
    expectedIsLoopEvent: false,
    expectedLoopFrameInterval: 0,
    expectedBulletAttack: 20,
    expectedBulletSize: 240,
  },
  {
    id: "active-skill-elemental-burst-snow-field-lv2",
    activeSkillId: 13,
    activeSkillLevel: 2,
    expectedEventFrame: 1,
    expectedShooterId: 13001,
    ...
    expectedIsLoopEvent: false,
    expectedLoopFrameInterval: 0,
    expectedBulletAttack: 40,
    expectedBulletSize: 280,
  },
  {
    id: "active-skill-elemental-burst-snow-field-lv3",
    activeSkillId: 13,
    activeSkillLevel: 3,
    expectedEventFrame: 1,
    expectedShooterId: 13002,
  ...
  },
  {
    ...
    expectedShooterBehaviorType: 1,
    expectedShooterFollowsOwnerDirection: true,
    expectedIsLoopEvent: false,
    expectedLoopFrameInterval: 0,
    expectedBulletAttack: 50,
    expectedBulletSize: 1100,
  },
  {
    id: "active-skill-endless-star-map-owner-forward-field-lv2",
    activeSkillId: 116,
    activeSkillLevel: 2,
    expectedEventFrame: 1,
    expectedShooterId: 10001,
    expectedSpawnPos: 0,
    expectedBulletTypeId: 64,
    expectedShooterBehaviorType: 1,
    expectedShooterFollowsOwnerDirection: true,
    expectedIsLoopEvent: false,
    expectedLoopFrameInterval: 0,
    expectedBulletAttack: 100,
    expectedBulletSize: 1100,
  },
  {
    id: "active-skill-endless-star-map-owner-forward-field-lv3",
    activeSkillId: 116,
    activeSkillLevel: 3,
    expectedEventFrame: 1,
    expectedShooterId: 10002,
    expectedSpawnPos: 0,
    expectedBulletTypeId: 64,
    expectedShooterBehaviorType: 1,
    expectedShooterFollowsOwnerDirection: true,
    expectedIsLoopEvent: false,
    expectedLoopFrameInterval: 0,
    expectedBulletAttack: 150,
    expectedBulletSize: 1100,
  },
  {
    id: "active-skill-ultimate-heart-light-looping-starlight-lv1",
    activeSkillId: 110,
    activeSkillLevel: 1,
    expectedEventFrame: 1,
    expectedShooterId: 6000,
    expectedSpawnPos: 0,
    expectedBulletTypeId: 28,
    expectedShooterBehaviorType: 1,
    expectedShooterFollowsOwnerDirection: true,
    expectedIsLoopEvent: true,
    expectedLoopFrameInterval: 10,
    expectedBulletAttack: 1,
    expectedBulletSize: 50,
  },
  {
    id: "active-skill-ultimate-heart-light-looping-starlight-lv2",
    activeSkillId: 110,
    activeSkillLevel: 2,
    expectedEventFrame: 1,
    expectedShooterId: 6001,
    expectedSpawnPos: 0,
    expectedBulletTypeId: 28,
    expectedShooterBehaviorType: 1,
    expectedShooterFollowsOwnerDirection: true,
  ...
  {
    id: "active-skill-ultimate-heart-light-looping-starlight-lv3",
    activeSkillId: 110,
    activeSkillLevel: 3,
    expectedEventFrame: 1,
    expectedShooterId: 6002,
    expectedSpawnPos: 0,
    expectedBulletTypeId: 28,
    expectedShooterBehaviorType: 1,
    expectedShooterFollowsOwnerDirection: true,
  ...
  },
  {
    ...
    expectedBulletSize: 3000,
  },
  {
    id: "active-skill-apocalypse-song-delayed-damage-lv2",
    activeSkillId: 14,
    activeSkillLevel: 2,
    expectedEventFrame: 90,
    expectedShooterId: 3002,
    expectedSpawnPos: 0,
    expectedBulletTypeId: 99,
    expectedIsLoopEvent: false,
    expectedLoopFrameInterval: 0,
  ...
  {
    id: "active-skill-apocalypse-song-delayed-damage-lv3",
    activeSkillId: 14,
    activeSkillLevel: 3,
    expectedEventFrame: 90,
    expectedShooterId: 3003,
    expectedSpawnPos: 0,
    expectedBulletTypeId: 99,
    expectedIsLoopEvent: false,
    expectedLoopFrameInterval: 0,
  ...
  },
  {
    ...
    expectedIsLoopEvent: false,
    expectedLoopFrameInterval: 0,
    expectedBulletAttack: 333,
    expectedBulletSize: 3000,
  },
  {
    id: "active-skill-zessho-static-field-lv2",
    activeSkillId: 114,
    activeSkillLevel: 2,
    expectedEventFrame: 1,
    expectedShooterId: 1002,
    expectedSpawnPos: 0,
    expectedBulletTypeId: 99,
    expectedShooterBehaviorType: 0,
    expectedShooterFollowsOwnerDirection: false,
    expectedIsLoopEvent: false,
    expectedLoopFrameInterval: 0,
    expectedBulletAttack: 666,
    expectedBulletSize: 3000,
  },
  {
    id: "active-skill-zessho-static-field-lv3",
    activeSkillId: 114,
    activeSkillLevel: 3,
    expectedEventFrame: 1,
    expectedShooterId: 1003,
    expectedSpawnPos: 0,
    expectedBulletTypeId: 99,
    expectedShooterBehaviorType: 0,
    expectedShooterFollowsOwnerDirection: false,
...
const ACTIVE_SKILL_SHOOTER_HIT_BUFF_CASE_SPECS: ActiveSkillShooterHitBuffCaseSpec[] = [
  ...
  {
    id: "active-skill-absolute-guard-shooter-friendly-invincible-buff-lv2",
    activeSkillId: 117,
    activeSkillLevel: 2,
    expectedEventFrame: 1,
    expectedShooterId: 11000,
  ...
  {
    id: "active-skill-absolute-guard-shooter-friendly-invincible-buff-lv3",
    activeSkillId: 117,
    activeSkillLevel: 3,
    expectedEventFrame: 1,
    expectedShooterId: 11000,
...
const ACTIVE_SKILL_SUMMON_CASE_SPECS: ActiveSkillSummonCaseSpec[] = [
  {
    ...
    expectedMinionAITypeId: 203,
    expectedMinionAIStateType: 21,
    expectedMinionAINextStateId: 1,
    expectedMinionAINextStateShooterId: 14000,
  ...
  {
    id: "active-skill-all-out-fire-middle-minion-lv2",
    activeSkillId: 112,
    activeSkillLevel: 2,
    ...
    expectedSameFrameSpawnMinionEventCount: 2,
    expectedMinionAIStateType: 22,
  ...
  {
    id: "active-skill-galaxy-star-ring-summon-lv2",
    activeSkillId: 113,
    activeSkillLevel: 2,
    expectedEventFrame: 1,
    expectedMinionId: 7,
  ...
  {
    id: "active-skill-galaxy-star-ring-summon-lv3",
    activeSkillId: 113,
    activeSkillLevel: 3,
    expectedEventFrame: 1,
    expectedMinionId: 7,
