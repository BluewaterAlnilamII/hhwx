...
export const MUSIC_PLAYER_PLAYBACK_BUTTON_CLASS_NAME =
  `${MUSIC_PLAYER_PLAYBACK_BUTTON_BASE_CLASS_NAME} bg-[var(--theme-color-progress-indicator-background)] text-[var(--theme-color-action-accent-foreground)] shadow-[var(--theme-shadow-action-primary)] focus-visible:ring-[var(--theme-color-focus-ring)]`;
