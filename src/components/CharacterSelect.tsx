...
function getThinkSpeedKey(thinkTime: Character["thinkTime"]): "thinkShort" | "thinkMedium" | "thinkLong" {
  if (thinkTime === "short") {
    return "thinkShort";
  }
  if (thinkTime === "medium") {
...
export default function CharacterSelect() {
  const t = useTranslations("othello.characterSelect");
  const {
    playerCharacter,
    selectionStep,
    setPlayerCharacter,
          ...
          {availableChars.map((char) => (
            ...
            >
              ...
              <div className="mt-auto pt-2">
                ...
                >
                  {t("thinkSpeed")} {t(getThinkSpeedKey(char.thinkTime))}
                </span>
              </div>
            </button>
          ))}
