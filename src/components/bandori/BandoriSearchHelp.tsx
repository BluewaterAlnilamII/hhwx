  ...
  return (
    <>
      ...
      <div
        ...
        tabIndex={0}
        className="fixed inset-auto m-0 max-h-[calc(100dvh-24px)] w-max max-w-[calc(100vw-24px)] overflow-auto rounded-xl border border-[var(--theme-color-border-subtle)] bg-[var(--theme-color-panel-background)] p-4 text-sm leading-7 text-[var(--theme-color-text-default)] shadow-[var(--theme-shadow-floating)] focus-visible:outline-2 focus-visible:outline-[var(--theme-color-semantic-info-border)]"
        onToggle={(event) => {
