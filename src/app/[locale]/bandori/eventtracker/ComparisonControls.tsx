  ...
  return (
    <div className="border-t border-[var(--theme-color-border-subtle)] px-1 pt-4 sm:px-2">
      <div className="flex flex-col items-center gap-3">
        {status === "进行中" && (
          <div className="flex flex-wrap items-center justify-center gap-2 rounded-[18px] bg-[var(--theme-color-surface-background)]/85 px-2 py-1.5 sm:gap-3">
            <button
              type="button"
              ...
              className={`inline-flex items-center gap-2 rounded-full border px-3 py-1.5 text-xs sm:text-sm font-semibold transition-all ${
                showInstantProjection
                  ? "border-red-300 bg-[var(--theme-color-control-background)] text-red-600 shadow-xs"
            ...
            <button
              ...
              className={`inline-flex items-center gap-2 rounded-full border px-3 py-1.5 text-xs sm:text-sm font-semibold transition-all ${
                showDayProjection
                  ? "border-blue-300 bg-[var(--theme-color-control-background)] text-blue-600 shadow-xs"
                  : "border-[var(--theme-color-border-subtle)] bg-[var(--theme-color-control-background)] text-[var(--theme-color-text-muted)]"
              }`}
            >
        ...
        {resolvedComparisonConfigs.length > 0 && (
          <div className="flex max-w-full flex-wrap items-center justify-center gap-2 rounded-[18px] bg-[var(--theme-color-surface-background)]/85 px-2 py-1.5 sm:gap-3">
                ...
                <button
                  ...
                  className={`inline-flex items-center gap-2 rounded-full border px-3 py-1.5 text-xs font-semibold transition-all sm:text-sm ${
                    config.enabled
                      ...
                      : "border-[var(--theme-color-border-subtle)] bg-[var(--theme-color-surface-background)] text-[var(--theme-color-text-muted)] opacity-60"
                  }`}
          ...
          <div className="flex flex-wrap items-center justify-center gap-2">
            ...
            {comparisonConfigs.length > 0 && (
              <button
                ...
                className="inline-flex h-8 items-center gap-1.5 rounded-full border border-[var(--theme-color-feedback-error-border)] bg-[var(--theme-color-feedback-error-background)] px-3 text-xs font-semibold text-[var(--theme-color-feedback-error-foreground)] transition-colors hover:brightness-95 sm:h-9 sm:text-sm"
                aria-label="移除全部对比线"
                title="移除全部对比线"
              >
                <Trash2 size={14} />
