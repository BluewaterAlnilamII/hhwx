...
export const BANDORI_CHARACTER_GROUPS: BandoriCharacterGroup[] = [
  ...
  { key: "hhw", label: "Hello, Happy World!", bandId: 3, characterIds: [11, 12, 13, 14, 15] },
  { key: "pp", label: "Pastel＊Palettes", bandId: 4, characterIds: [16, 17, 18, 19, 20] },
  { key: "roselia", label: "Roselia", bandId: 5, characterIds: [21, 22, 23, 24, 25] },
  ...
  { key: "mygo", label: "MyGO!!!!!", bandId: 45, characterIds: [36, 37, 38, 39, 40] },
];
