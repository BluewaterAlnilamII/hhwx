...
export function searchBandoriBestMedleyTeams(input: BandoriMedleyTeamSearchInput): BandoriMedleyTeamSearchResponse {
  ...
  const parsedDebugExactCandidateRawMirrorMaxCandidateTotal = (
    optimization.debugExactCandidateRawMirrorMaxCandidateTotal !== undefined
      ? Math.trunc(optimization.debugExactCandidateRawMirrorMaxCandidateTotal)
      : Number.NaN
  );
  const debugExactCandidateRawMirrorMaxCandidateTotal = (
    Number.isFinite(parsedDebugExactCandidateRawMirrorMaxCandidateTotal)
    && parsedDebugExactCandidateRawMirrorMaxCandidateTotal > 0
      ? parsedDebugExactCandidateRawMirrorMaxCandidateTotal
      : null
  );
  ...
  const debugExactCandidateAnchorFrontierCheapUpperProbe = (
  ...
  const debugExactCandidatePrefixCapacityBatchReplay = (
    optimization.debugExactCandidatePrefixCapacityBatchReplay === true
  );
  const enableExactCandidateCapacityBatchPruning = (
    optimization.enableExactCandidateCapacityBatchPruning === true
  );
  const debugExactCandidatePrefixCapacityLevel3Replay = (
    optimization.debugExactCandidatePrefixCapacityLevel3Replay === true
  );
  const debugExactCandidatePrefixCapacityLevel3LookaheadReplay = (
    optimization.debugExactCandidatePrefixCapacityLevel3LookaheadReplay === true
  );
  const enableExactCandidateCapacitySourceLeafPruning = (
    optimization.enableExactCandidateCapacitySourceLeafPruning === true
  );
  const enableExactCandidateCapacityLevel3LookaheadPruning = (
    optimization.enableExactCandidateCapacityLevel3LookaheadPruning === true
  );
  const debugExactCandidateAdmissionPairProbe = optimization.debugExactCandidateAdmissionPairProbe === true;
  ...
  const debugExactCandidateRawAnchorFrontierConstrainedPeekProbe = (
    optimization.debugExactCandidateRawAnchorFrontierConstrainedPeekProbe === true
  );
  const debugExactCandidateRawPairPricingFrontierProbe = (
  ...
  const debugExactCandidateRawPairComplementParity = (
    optimization.debugExactCandidateRawPairComplementParity === true
  );
  const debugExactCandidateRawPairUpperScanParity = (
  ...
  const debugExactCandidateRawSolverHandoff = optimization.debugExactCandidateRawSolverHandoff === true;
  const debugExactCandidateRawResidentFill = optimization.debugExactCandidateRawResidentFill === true;
  const enableExactCandidateRawResidentResult = optimization.enableExactCandidateRawResidentResult === true;
  const enableExactCandidateRawResidentWinnerOracle = (
    optimization.enableExactCandidateRawResidentWinnerOracle === true
  );
  const enableExactCandidateRawPairComplementUpper = (
    ...
    if (shouldPreferExactCandidateJoinBeforeSeeding) {
      ...
      const exactJoinResult = searchMedleyConfigurationByExactCandidateJoin(
        ...
        exactNodeSoftLimit,
        {
          ...
          debugExactCandidatePrefixCapacityBatchReplay,
          enableExactCandidateCapacityBatchPruning,
          debugExactCandidatePrefixCapacityLevel3Replay,
          debugExactCandidatePrefixCapacityLevel3LookaheadReplay,
          enableExactCandidateCapacitySourceLeafPruning,
          enableExactCandidateCapacityLevel3LookaheadPruning,
          debugExactCandidateAdmissionPairProbe,
          debugExactCandidateDominanceReplay,
          debugExactCandidateRawAnchorCheapUpperReplay,
          debugExactCandidateRawAnchorFrontierProbe,
          debugExactCandidateRawAnchorFrontierConstrainedPeekProbe,
          debugExactCandidateRawPairPricingFrontierProbe,
          ...
          debugExactCandidateRawSolverHandoff,
          debugExactCandidateRawResidentFill,
          enableExactCandidateRawResidentResult,
          enableExactCandidateRawResidentWinnerOracle,
          enableExactCandidateRawPairComplementUpper,
