...
function buildProofLedger(
  ...
  return configurationTrace.map((entry) => {
    ...
    return {
      ...
      dominatedRootFrontierPass: entry.dominatedRootFrontierPass === true,
      dominatedRootFrontierPassCount: asFiniteNumber(entry.dominatedRootFrontierPassCount),
      dominatedRootFrontierPassGap: asFiniteNumber(entry.dominatedRootFrontierPassGap),
      dominatedRootFrontierPassMinGap: asFiniteNumber(entry.dominatedRootFrontierPassMinGap),
      dominatedRootFrontierPassRemainingMs: asFiniteNumber(entry.dominatedRootFrontierPassRemainingMs),
      dominatedRootFrontierPassMinRemainingMs: asFiniteNumber(entry.dominatedRootFrontierPassMinRemainingMs),
      ...
      optionalProbeDeltas: {
        ...
        anchorFrontierCheapUpperTargetedPairProofAttemptCount: (
          asFiniteNumber(entry.exactCandidateJoinLastAnchorFrontierCheapUpperTargetedPairProofAttemptCount)
        ),
        anchorFrontierCheapUpperTargetedPairProofProcessedEntryCount: (
          asFiniteNumber(entry.exactCandidateJoinLastAnchorFrontierCheapUpperTargetedPairProofProcessedEntryCount)
        ),
        anchorFrontierCheapUpperTargetedPairProofImprovementCount: (
          asFiniteNumber(entry.exactCandidateJoinLastAnchorFrontierCheapUpperTargetedPairProofImprovementCount)
        ),
        anchorFrontierCheapUpperTargetedPairProofTimeboxCount: (
          asFiniteNumber(entry.exactCandidateJoinLastAnchorFrontierCheapUpperTargetedPairProofTimeboxCount)
        ),
        anchorFrontierCheapUpperTargetedPairProofElapsedMs: (
          asFiniteNumber(entry.exactCandidateJoinLastAnchorFrontierCheapUpperTargetedPairProofElapsedMs)
        ),
        ...
        anchorFrontierCheapUpperPairCapacitySharedPowerDualLateRepairImprovementCount: (
          asFiniteNumber(
            entry
              .exactCandidateJoinLastAnchorFrontierCheapUpperPairCapacitySharedPowerDualLateRepairImprovementCount,
          )
        ),
        anchorFrontierCheapUpperPairCapacitySharedPowerDualLateRepairBestImprovement: (
          asFiniteNumber(
            entry
        ...
        anchorFrontierCheapUpperProcessedUnseenJoinPairCount: (
          asFiniteNumber(entry.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinPairCount)
        ),
        anchorFrontierCheapUpperProcessedUnseenJoinElapsedMs: (
          asFiniteNumber(entry.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinElapsedMs)
        ),
        anchorFrontierCheapUpperProcessedUnseenJoinAbortReason: (
          entry.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinAbortReason ?? null
        ),
        anchorFrontierCheapUpperProcessedUnseenJoinMaxSource: (
          entry.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxSource ?? null
        ),
        anchorFrontierCheapUpperProcessedUnseenJoinMaxAnchorScore: (
          asFiniteNumber(entry.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxAnchorScore)
        ),
        anchorFrontierCheapUpperProcessedUnseenJoinMaxGeneratedPairUpper: (
          asFiniteNumber(entry.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxGeneratedPairUpper)
        ),
        anchorFrontierCheapUpperProcessedUnseenJoinMaxBothUnseenFallbackPairUpper: (
          asFiniteNumber(
            entry
              .exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxBothUnseenFallbackPairUpper,
          )
        ),
        anchorFrontierCheapUpperProcessedUnseenJoinMaxGeneratedCandidateScore: (
          asFiniteNumber(
            entry
              .exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxGeneratedCandidateScore,
          )
        ),
        anchorFrontierCheapUpperProcessedUnseenJoinMaxGeneratedUnseenUpper: (
          asFiniteNumber(
            entry.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxGeneratedUnseenUpper,
          )
        ),
        anchorFrontierCheapUpperProcessedUnseenJoinMaxEntryIndex: (
          asFiniteNumber(entry.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxEntryIndex)
        ),
        anchorFrontierCheapUpperProcessedUnseenJoinMaxGeneratedIndex: (
          asFiniteNumber(entry.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxGeneratedIndex)
        ),
        ...
        anchorFrontierCheapUpperPairAnchorCoverPairCount: (
          asFiniteNumber(entry.exactCandidateJoinLastAnchorFrontierCheapUpperPairAnchorCoverPairCount)
        ),
        anchorFrontierCheapUpperPairAnchorCoverDistinctCardCount: (
          asFiniteNumber(entry.exactCandidateJoinLastAnchorFrontierCheapUpperPairAnchorCoverDistinctCardCount)
        ),
        anchorFrontierCheapUpperPairAnchorCoverElapsedMs: (
          asFiniteNumber(entry.exactCandidateJoinLastAnchorFrontierCheapUpperPairAnchorCoverElapsedMs)
        ),
        anchorFrontierCheapUpperPairAnchorCoverAbortReason: (
          entry.exactCandidateJoinLastAnchorFrontierCheapUpperPairAnchorCoverAbortReason ?? null
        ),
...
function buildBoundedFrontierGroups(
  ...
  for (const entry of configurationTrace) {
    ...
    group.entries.push({
      ...
      anchorFrontierCheapUpperResidualSource: (
        entry.exactCandidateJoinLastAnchorFrontierCheapUpperResidualSource ?? null
      ),
      anchorFrontierCheapUpperUnprocessedAnchorScore: (
        entry.exactCandidateJoinLastAnchorFrontierCheapUpperUnprocessedAnchorScore ?? null
      ),
      ...
      anchorFrontierCheapUpperSuffixCoverDistinctCardSetCount: (
        entry.exactCandidateJoinLastAnchorFrontierCheapUpperSuffixCoverDistinctCardSetCount ?? null
      ),
      anchorFrontierCheapUpperSuffixCoverMode: (
        entry.exactCandidateJoinLastAnchorFrontierCheapUpperSuffixCoverMode ?? null
      ),
      ...
      anchorFrontierCheapUpperSuffixUnseenSingleCardJoinRightUpperBound: (
        entry.exactCandidateJoinLastAnchorFrontierCheapUpperSuffixUnseenSingleCardJoinRightUpperBound ?? null
      ),
      anchorFrontierCheapUpperSuffixUnseenSingleCardJoinPairCount: (
        entry.exactCandidateJoinLastAnchorFrontierCheapUpperSuffixUnseenSingleCardJoinPairCount ?? null
      ),
      anchorFrontierCheapUpperSuffixUnseenSingleCardJoinElapsedMs: (
        entry.exactCandidateJoinLastAnchorFrontierCheapUpperSuffixUnseenSingleCardJoinElapsedMs ?? null
      ),
      anchorFrontierCheapUpperSuffixUnseenSingleCardJoinAbortReason: (
        entry.exactCandidateJoinLastAnchorFrontierCheapUpperSuffixUnseenSingleCardJoinAbortReason ?? null
      ),
        anchorFrontierCheapUpperSuffixUnseenJoinMode: (
          entry.exactCandidateJoinLastAnchorFrontierCheapUpperSuffixUnseenJoinMode ?? null
        ),
        anchorFrontierCheapUpperProcessedUnseenJoinUpperBound: (
          entry.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinUpperBound ?? null
        ),
        anchorFrontierCheapUpperProcessedUnseenJoinPairCount: (
          entry.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinPairCount ?? null
        ),
        anchorFrontierCheapUpperProcessedUnseenJoinElapsedMs: (
          entry.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinElapsedMs ?? null
        ),
        anchorFrontierCheapUpperProcessedUnseenJoinAbortReason: (
          entry.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinAbortReason ?? null
        ),
        ...
        anchorFrontierCheapUpperProcessedUnseenJoinMaxAnchorScore: (
          entry.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxAnchorScore ?? null
        ),
        anchorFrontierCheapUpperProcessedUnseenJoinMaxGeneratedPairUpper: (
          entry.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxGeneratedPairUpper ?? null
        ),
        anchorFrontierCheapUpperProcessedUnseenJoinMaxBothUnseenFallbackPairUpper: (
          entry.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxBothUnseenFallbackPairUpper
          ?? null
        ),
        anchorFrontierCheapUpperProcessedUnseenJoinMaxGeneratedCandidateScore: (
          entry.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxGeneratedCandidateScore
          ?? null
        ),
        anchorFrontierCheapUpperProcessedUnseenJoinMaxGeneratedUnseenUpper: (
          entry.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxGeneratedUnseenUpper ?? null
        ),
        anchorFrontierCheapUpperProcessedUnseenJoinMaxEntryIndex: (
          entry.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxEntryIndex ?? null
        ),
        anchorFrontierCheapUpperProcessedUnseenJoinMaxGeneratedIndex: (
          entry.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxGeneratedIndex ?? null
        ),
        anchorFrontierCheapUpperProcessedUnseenJoinMaxUnseenSlotIndex: (
        ...
        anchorFrontierCheapUpperPairAnchorCoverUpperBound: (
          entry.exactCandidateJoinLastAnchorFrontierCheapUpperPairAnchorCoverUpperBound ?? null
        ),
        anchorFrontierCheapUpperPairAnchorCoverPairCount: (
          entry.exactCandidateJoinLastAnchorFrontierCheapUpperPairAnchorCoverPairCount ?? null
        ),
        anchorFrontierCheapUpperPairAnchorCoverDistinctCardCount: (
          entry.exactCandidateJoinLastAnchorFrontierCheapUpperPairAnchorCoverDistinctCardCount ?? null
        ),
        anchorFrontierCheapUpperPairAnchorCoverElapsedMs: (
          entry.exactCandidateJoinLastAnchorFrontierCheapUpperPairAnchorCoverElapsedMs ?? null
        ),
        anchorFrontierCheapUpperPairAnchorCoverAbortReason: (
          entry.exactCandidateJoinLastAnchorFrontierCheapUpperPairAnchorCoverAbortReason ?? null
        ),
      ...
      anchorFrontierCheapUpperTargetedPairProofAttemptCount: (
        entry.exactCandidateJoinLastAnchorFrontierCheapUpperTargetedPairProofAttemptCount ?? null
      ),
      anchorFrontierCheapUpperTargetedPairProofProcessedEntryCount: (
        entry.exactCandidateJoinLastAnchorFrontierCheapUpperTargetedPairProofProcessedEntryCount ?? null
      ),
      anchorFrontierCheapUpperTargetedPairProofImprovementCount: (
        entry.exactCandidateJoinLastAnchorFrontierCheapUpperTargetedPairProofImprovementCount ?? null
      ),
      anchorFrontierCheapUpperTargetedPairProofTimeboxCount: (
        entry.exactCandidateJoinLastAnchorFrontierCheapUpperTargetedPairProofTimeboxCount ?? null
      ),
      anchorFrontierCheapUpperTargetedPairProofElapsedMs: (
        entry.exactCandidateJoinLastAnchorFrontierCheapUpperTargetedPairProofElapsedMs ?? null
      ),
      anchorFrontierCheapUpperTargetedPairProofAbortReason: (
        entry.exactCandidateJoinLastAnchorFrontierCheapUpperTargetedPairProofAbortReason ?? null
      ),
...
export function searchBandoriBestMedleyTeams(input: BandoriMedleyTeamSearchInput): BandoriMedleyTeamSearchResponse {
  ...
  const enableExactCandidateJoinGlobalCapacityTailUpper = (
    optimization.enableExactCandidateJoinGlobalCapacityTailUpper === true
  );
  const parsedExactCandidateJoinGlobalCapacityTailMinSelectedCards = (
    optimization.exactCandidateJoinGlobalCapacityTailMinSelectedCards !== undefined
      ? Math.trunc(optimization.exactCandidateJoinGlobalCapacityTailMinSelectedCards)
      : Number.NaN
  );
  const exactCandidateJoinGlobalCapacityTailMinSelectedCards = Number.isFinite(
    parsedExactCandidateJoinGlobalCapacityTailMinSelectedCards,
  )
  ...
  const eventRootFrontierProbeAnchorCheapUpperTimeboxMs = Number.isFinite(
    ...
    : null;
  const parsedEventRootFrontierProbeAnchorCheapUpperMinRemainingMs =
    optimization.eventRootFrontierProbeAnchorCheapUpperMinRemainingMs !== undefined
      ? Math.trunc(optimization.eventRootFrontierProbeAnchorCheapUpperMinRemainingMs)
      : Number.NaN;
  const eventRootFrontierProbeAnchorCheapUpperMinRemainingMs = Number.isFinite(
    parsedEventRootFrontierProbeAnchorCheapUpperMinRemainingMs,
  )
    ? Math.max(0, parsedEventRootFrontierProbeAnchorCheapUpperMinRemainingMs)
    : null;
  ...
  const eventRootFrontierProbeAnchorCheapUpperBestPrefixSplitMaxAttempts = Number.isFinite(
    ...
    : null;
  const eventRootFrontierProbeAnchorCheapUpperPairAnchorCover = (
    optimization.eventRootFrontierProbeAnchorCheapUpperPairAnchorCover === true
  );
  const parsedEventRootFrontierProbeAnchorCheapUpperPairAnchorCoverMaxPairs =
    optimization.eventRootFrontierProbeAnchorCheapUpperPairAnchorCoverMaxPairs !== undefined
      ? Math.trunc(optimization.eventRootFrontierProbeAnchorCheapUpperPairAnchorCoverMaxPairs)
      : Number.NaN;
  const eventRootFrontierProbeAnchorCheapUpperPairAnchorCoverMaxPairs = Number.isFinite(
    parsedEventRootFrontierProbeAnchorCheapUpperPairAnchorCoverMaxPairs,
  )
  ...
  const eventRootFrontierProbeAnchorCheapUpperLocalPairSlotExtensionTimeboxMs = Number.isFinite(
    ...
    : null;
  const eventRootFrontierProbeAnchorCheapUpperPairCapacityCap = (
    optimization.eventRootFrontierProbeAnchorCheapUpperPairCapacityCap === true
  );
  const eventRootFrontierProbeAnchorCheapUpperPairCapacityCapPareto = (
    optimization.eventRootFrontierProbeAnchorCheapUpperPairCapacityCapPareto === true
  );
  ...
  const eventRootFrontierProbeAnchorCheapUpperPairCapacitySharedPowerDualLateMaxRepair = (
    optimization.eventRootFrontierProbeAnchorCheapUpperPairCapacitySharedPowerDualLateMaxRepair === true
  );
  ...
  const parsedEventRootFrontierProbeAnchorCheapUpperPairCapacitySharedPowerStateBudget =
    optimization.eventRootFrontierProbeAnchorCheapUpperPairCapacitySharedPowerStateBudget !== undefined
      ? Math.trunc(optimization.eventRootFrontierProbeAnchorCheapUpperPairCapacitySharedPowerStateBudget)
      : Number.NaN;
  const eventRootFrontierProbeAnchorCheapUpperPairCapacitySharedPowerStateBudget = Number.isFinite(
    parsedEventRootFrontierProbeAnchorCheapUpperPairCapacitySharedPowerStateBudget,
  )
    ? Math.max(1, parsedEventRootFrontierProbeAnchorCheapUpperPairCapacitySharedPowerStateBudget)
    : null;
  const parsedEventRootFrontierProbeAnchorCheapUpperTargetedPairProofTimeboxMs =
    optimization.eventRootFrontierProbeAnchorCheapUpperTargetedPairProofTimeboxMs !== undefined
      ...
      : Number.NaN;
  const eventRootFrontierProbeAnchorCheapUpperTargetedPairProofTimeboxMs = Number.isFinite(
    parsedEventRootFrontierProbeAnchorCheapUpperTargetedPairProofTimeboxMs,
  )
    ? Math.max(0, parsedEventRootFrontierProbeAnchorCheapUpperTargetedPairProofTimeboxMs)
    : null;
  const parsedEventRootFrontierProbeAnchorCheapUpperTargetedPairProofMaxEntries =
    optimization.eventRootFrontierProbeAnchorCheapUpperTargetedPairProofMaxEntries !== undefined
      ? Math.trunc(optimization.eventRootFrontierProbeAnchorCheapUpperTargetedPairProofMaxEntries)
      : Number.NaN;
  const eventRootFrontierProbeAnchorCheapUpperTargetedPairProofMaxEntries = Number.isFinite(
    parsedEventRootFrontierProbeAnchorCheapUpperTargetedPairProofMaxEntries,
  )
    ? Math.max(1, parsedEventRootFrontierProbeAnchorCheapUpperTargetedPairProofMaxEntries)
    : null;
  const parsedEventRootFrontierProbeAnchorCheapUpperTargetedPairProofCandidateLimit =
    optimization.eventRootFrontierProbeAnchorCheapUpperTargetedPairProofCandidateLimit !== undefined
      ? Math.trunc(optimization.eventRootFrontierProbeAnchorCheapUpperTargetedPairProofCandidateLimit)
      : Number.NaN;
  const eventRootFrontierProbeAnchorCheapUpperTargetedPairProofCandidateLimit = Number.isFinite(
    parsedEventRootFrontierProbeAnchorCheapUpperTargetedPairProofCandidateLimit,
  )
    ? Math.max(1, parsedEventRootFrontierProbeAnchorCheapUpperTargetedPairProofCandidateLimit)
    : null;
  const parsedEventRootFrontierProbeAnchorCheapUpperTargetedPairBnbNodeLimit =
    optimization.eventRootFrontierProbeAnchorCheapUpperTargetedPairBnbNodeLimit !== undefined
      ? Math.trunc(optimization.eventRootFrontierProbeAnchorCheapUpperTargetedPairBnbNodeLimit)
      : Number.NaN;
  const eventRootFrontierProbeAnchorCheapUpperTargetedPairBnbNodeLimit = Number.isFinite(
    parsedEventRootFrontierProbeAnchorCheapUpperTargetedPairBnbNodeLimit,
  )
    ? Math.max(1, parsedEventRootFrontierProbeAnchorCheapUpperTargetedPairBnbNodeLimit)
    : null;
  const parsedEventRootFrontierProbeAnchorCheapUpperTargetedPairBnbSlotSolveNodeLimit =
    optimization.eventRootFrontierProbeAnchorCheapUpperTargetedPairBnbSlotSolveNodeLimit !== undefined
      ? Math.trunc(optimization.eventRootFrontierProbeAnchorCheapUpperTargetedPairBnbSlotSolveNodeLimit)
      : Number.NaN;
  const eventRootFrontierProbeAnchorCheapUpperTargetedPairBnbSlotSolveNodeLimit = Number.isFinite(
    parsedEventRootFrontierProbeAnchorCheapUpperTargetedPairBnbSlotSolveNodeLimit,
  )
  ...
  const eventRootFrontierProbeAnchorCheapUpperSuffixUnseenSingleCardJoin = (
    optimization.eventRootFrontierProbeAnchorCheapUpperSuffixUnseenSingleCardJoin === true
  );
  const eventRootFrontierProbeAnchorCheapUpperSuffixUnseenFullJoin = (
    optimization.eventRootFrontierProbeAnchorCheapUpperSuffixUnseenFullJoin === true
  );
  const exactJoinWideAnchorFrontierContext = enableExactJoinWideAnchorFrontierProbe
    ? {
      ...
      anchorFrontierCheapUpperPairCapacityCap: eventRootFrontierProbeAnchorCheapUpperPairCapacityCap,
      anchorFrontierCheapUpperPairCapacityCapPareto: (
      ...
      anchorFrontierCheapUpperPairCapacitySharedPowerStateBudget: (
        eventRootFrontierProbeAnchorCheapUpperPairCapacitySharedPowerStateBudget
      ),
      anchorFrontierCheapUpperTargetedPairProofTimeboxMs: (
        eventRootFrontierProbeAnchorCheapUpperTargetedPairProofTimeboxMs
      ),
      anchorFrontierCheapUpperTargetedPairProofMaxEntries: (
        eventRootFrontierProbeAnchorCheapUpperTargetedPairProofMaxEntries
      ),
      anchorFrontierCheapUpperTargetedPairProofCandidateLimit: (
        eventRootFrontierProbeAnchorCheapUpperTargetedPairProofCandidateLimit
      ),
      anchorFrontierCheapUpperTargetedPairBnbNodeLimit: (
        eventRootFrontierProbeAnchorCheapUpperTargetedPairBnbNodeLimit
      ),
      ...
      anchorFrontierCheapUpperSuffixUnseenSingleCardJoin: (
        eventRootFrontierProbeAnchorCheapUpperSuffixUnseenSingleCardJoin
      ),
      anchorFrontierCheapUpperSuffixUnseenFullJoin: (
  ...
  const lowMemoryHighPairPrefixRecordLimit = enableLowMemoryHighPairPrefixUpper
    ? Number.isFinite(parsedLowMemoryHighPairPrefixRecordLimit)
      ...
      : MEDLEY_EXACT_CANDIDATE_JOIN_LOW_MEMORY_HIGH_PAIR_PREFIX_RECORD_LIMIT
    : null;
  const enableLowMemoryHighPairRecordScan = optimization.enableLowMemoryHighPairRecordScan === true;
    ...
    try {
      ...
      for (const slot of reevaluationSlots) {
        ...
        const candidate = evaluateMedleySlotCandidateWithCache(
          slot,
          selectedCards as NonNullable<(typeof selectedCards)[number]>[],
          server,
          perfectRate,
          stats,
          profiling,
  ...
  for (const configuration of orderedConfigurations) {
    ...
    const finishConfigurationTrace = (status: string): void => {
      ...
      if (profiling.exactCandidateJoinCallCount > traceStartCounters.exactCandidateJoinCallCount) {
        Object.assign(traceEntry, {
          ...
          exactCandidateJoinLastAnchorFrontierCheapUpperPairCapacitySharedPowerDualCapCallCount: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperPairCapacitySharedPowerDualCapCallCount
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperPairCapacitySharedPowerDualCapImprovementCount: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperPairCapacitySharedPowerDualCapImprovementCount
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperPairCapacitySharedPowerDualCapBestImprovement: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperPairCapacitySharedPowerDualCapBestImprovement
          ),
          ...
          exactCandidateJoinLastAnchorFrontierCheapUpperUnprocessedAnchorScore: (
          ...
          exactCandidateJoinLastAnchorFrontierCheapUpperSuffixCoverDistinctCardSetCount: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperSuffixCoverDistinctCardSetCount
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperSuffixCoverMode: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperSuffixCoverMode
          ),
          ...
          exactCandidateJoinLastAnchorFrontierCheapUpperSuffixUnseenSingleCardJoinRightUpperBound: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperSuffixUnseenSingleCardJoinRightUpperBound
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperSuffixUnseenSingleCardJoinPairCount: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperSuffixUnseenSingleCardJoinPairCount
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperSuffixUnseenSingleCardJoinElapsedMs: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperSuffixUnseenSingleCardJoinElapsedMs
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperSuffixUnseenSingleCardJoinAbortReason: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperSuffixUnseenSingleCardJoinAbortReason
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperSuffixUnseenJoinMode: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperSuffixUnseenJoinMode
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinUpperBound: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinUpperBound
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinPairCount: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinPairCount
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinElapsedMs: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinElapsedMs
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinAbortReason: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinAbortReason
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxSource: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxSource
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxAnchorScore: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxAnchorScore
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxGeneratedPairUpper: (
          ...
          exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxGeneratedUnseenUpper: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxGeneratedUnseenUpper
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxEntryIndex: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxEntryIndex
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinMaxGeneratedIndex: (
          ...
          exactCandidateJoinLastAnchorFrontierCheapUpperPairAnchorCoverPairCount: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperPairAnchorCoverPairCount
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperPairAnchorCoverDistinctCardCount: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperPairAnchorCoverDistinctCardCount
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperPairAnchorCoverElapsedMs: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperPairAnchorCoverElapsedMs
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperPairAnchorCoverAbortReason: (
          ...
          exactCandidateJoinLastAnchorFrontierCheapUpperTargetedPairProofAttemptCount: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperTargetedPairProofAttemptCount
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperTargetedPairProofProcessedEntryCount: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperTargetedPairProofProcessedEntryCount
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperTargetedPairProofImprovementCount: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperTargetedPairProofImprovementCount
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperTargetedPairProofTimeboxCount: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperTargetedPairProofTimeboxCount
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperTargetedPairProofElapsedMs: (
            profiling.exactCandidateJoinLastAnchorFrontierCheapUpperTargetedPairProofElapsedMs
          ),
          exactCandidateJoinLastAnchorFrontierCheapUpperTargetedPairProofAbortReason: (
    ...
    if (traceEntry) {
      ...
      traceEntry.enableExactCandidateJoinGlobalCapacityTailUpper = (
    ...
    if (shouldPreferExactCandidateJoinBeforeSeeding) {
      ...
      const exactJoinResult = searchMedleyConfigurationByExactCandidateJoin(
        ...
        exactNodeSoftLimit,
        {
          ...
          lowMemoryHighPairRecordScan: enableLowMemoryHighPairRecordScan,
    ...
    const maybeRunEventRootFrontierProbe = (
      ...
      if (traceEntry) {
        ...
        traceEntry.eventRootFrontierProbeAnchorCheapUpperMinRemainingMs = (
        ...
        traceEntry.eventRootFrontierProbeAnchorCheapUpperPairAnchorCover = (
        ...
        traceEntry.eventRootFrontierProbeAnchorCheapUpperPairCapacityCap = (
          eventRootFrontierProbeAnchorCheapUpperPairCapacityCap
        );
        traceEntry.eventRootFrontierProbeAnchorCheapUpperPairCapacityCapPareto = (
          eventRootFrontierProbeAnchorCheapUpperPairCapacityCapPareto
        );
        ...
        traceEntry.eventRootFrontierProbeAnchorCheapUpperPairCapacitySharedPowerStateBudget = (
          eventRootFrontierProbeAnchorCheapUpperPairCapacitySharedPowerStateBudget
        );
        traceEntry.eventRootFrontierProbeAnchorCheapUpperTargetedPairProofTimeboxMs = (
          eventRootFrontierProbeAnchorCheapUpperTargetedPairProofTimeboxMs
        );
        traceEntry.eventRootFrontierProbeAnchorCheapUpperTargetedPairProofMaxEntries = (
          eventRootFrontierProbeAnchorCheapUpperTargetedPairProofMaxEntries
        );
        traceEntry.eventRootFrontierProbeAnchorCheapUpperTargetedPairProofCandidateLimit = (
          eventRootFrontierProbeAnchorCheapUpperTargetedPairProofCandidateLimit
        );
        traceEntry.eventRootFrontierProbeAnchorCheapUpperTargetedPairBnbNodeLimit = (
          eventRootFrontierProbeAnchorCheapUpperTargetedPairBnbNodeLimit
        );
        ...
        traceEntry.eventRootFrontierProbeAnchorCheapUpperSuffixUnseenSingleCardJoin = (
          eventRootFrontierProbeAnchorCheapUpperSuffixUnseenSingleCardJoin
        );
        traceEntry.eventRootFrontierProbeAnchorCheapUpperSuffixUnseenFullJoin = (
          eventRootFrontierProbeAnchorCheapUpperSuffixUnseenFullJoin
        );
      }
