...
export type BandoriMedleyTeamSearchProfilingStats = {
  ...
  exactCandidateJoinLastAnchorFrontierPrecheckSlotIndex: number | null;
  exactCandidateJoinLastAnchorFrontierPrecheckCalculatedCardCount: number | null;
  exactCandidateJoinLastAnchorFrontierPrecheckMaxCardCount: number | null;
  exactCandidateJoinLastAnchorFrontierPrecheckAnchorCandidateCount: number | null;
  exactCandidateJoinLastAnchorFrontierPrecheckMaxAnchorCandidateCount: number | null;
  exactCandidateJoinLastAnchorFrontierPrecheckOtherSlotCandidateCounts: number[];
  exactCandidateJoinLastAnchorFrontierPrecheckOtherSlotCandidateTotal: number | null;
  exactCandidateJoinLastAnchorFrontierPrecheckMaxOtherSlotCandidateCount: number | null;
  exactCandidateJoinLastAnchorFrontierPrecheckMaxOtherSlotCandidateTotal: number | null;
  exactCandidateJoinLastAnchorFrontierPrecheckFrontierGap: number | null;
  exactCandidateJoinLastAnchorFrontierPrecheckMaxFrontierGap: number | null;
  exactCandidateJoinLastAnchorFrontierPrecheckPeekUpperBound: number | null;
  exactCandidateJoinLastAnchorFrontierPrecheckOtherUpper: number | null;
  exactCandidateJoinLastAnchorFrontierPrecheckIncumbentScore: number | null;
  exactCandidateJoinLastAnchorFrontierPrecheckRemainingMs: number | null;
  exactCandidateJoinLastAnchorFrontierPrecheckMinRemainingMs: number | null;
  ...
  exactCandidateJoinPreMaterializationCensus: Record<string, unknown> | null;
...
export type MedleyExactSlotCandidateSearchNode = {
  ...
  prefixCapacityBatchReplayLevel?: number;
...
export type MedleyExactSlotCandidateGenerator = {
  ...
  prefixUpperReplayProfile?: () => Record<string, unknown> | null;
  preMaterializationCensusProfile?: () => Record<string, unknown> | null;
};
