...
export type BandoriMedleySearchOptimizationOptions = {
  ...
  enableLowMemoryHighPairRecordScan?: boolean;
  ...
  eventRootFrontierProbeAnchorCheapUpperStreamAnchorTail?: boolean;
  eventRootFrontierProbeAnchorCheapUpperStreamAnchorTailMaxCandidates?: number;
  eventRootFrontierProbeAnchorCheapUpperStreamAnchorTailTimeboxMs?: number;
  eventRootFrontierProbeAnchorCheapUpperStreamAnchorTailGlobalPruning?: boolean;
  ...
  eventRootFrontierProbeAnchorCheapUpperProcessedUnseenJoin?: boolean;
  eventRootFrontierProbeAnchorCheapUpperRewindBothUnseen?: boolean;
  eventRootFrontierProbeAnchorCheapUpperBestPrefixSplit?: boolean;
...
export type BandoriMedleyTeamSearchProfilingStats = {
  ...
  exactCandidateJoinLastAnchorFrontierCheapUpperProcessedUnseenJoinUpperBound: number | null;
  ...
  exactCandidateJoinLastAnchorFrontierCheapUpperRewindAttemptCount: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperRewindImprovementCount: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperRewindUpperBound: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperRewindSplitAnchorIndex: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperRewindProcessedEntryCount: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperRewindElapsedMs: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperRewindAbortReason: string | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperBestPrefixSplitAttemptCount: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperBestPrefixSplitImprovementCount: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperBestPrefixSplitUpperBound: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperBestPrefixSplitAnchorIndex: number | null;
  ...
  exactCandidateJoinLastAnchorFrontierCheapUpperStreamAnchorTailCandidateCount: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperStreamAnchorTailPeekBefore: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperStreamAnchorTailPeekAfter: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperStreamAnchorTailGlobalPeekBefore: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperStreamAnchorTailGlobalPeekAfter: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperStreamAnchorTailUpperBound: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperStreamAnchorTailElapsedMs: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperStreamAnchorTailAbortReason: string | null;
  ...
  exactCandidateJoinLastAnchorFrontierCheapUpperPairCapacitySharedPowerDualCapCallCount: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperPairCapacitySharedPowerDualCapImprovementCount: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperPairCapacitySharedPowerDualCapBestImprovement: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperPairCapacitySharedPowerDualCapElapsedMs: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperPairCapacitySharedPowerDualReuseCallCount: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperPairCapacitySharedPowerDualReuseImprovementCount: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperPairCapacitySharedPowerDualReuseBestImprovement: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperPairCapacitySharedPowerDualReuseElapsedMs: number | null;
  exactCandidateJoinLastAnchorFrontierCheapUpperPairCapacitySharedPowerDualReuseParameterCount: number | null;
