...
- When request parsing, input validation, response construction, or a public API contract moves into a shared module, add that module's exact path to the registry above. Do not broaden the registry to all of `src/lib/**`.
