...
3. Add a shadow raw candidate builder:
   ...
   - raw rows now include `cardSearchIndex0..4`; the next raw-builder step is a raw-row hydration API that reconstructs selected cards from `slot.searchCards` without `sourceIndex`.
