...
3. Add a shadow raw candidate builder:
   ...
   - next raw-builder step: prototype opt-in raw-resident fill for small rows, where rich candidates are not retained beyond debug/oracle mode and final output is late-hydrated from raw rows.
