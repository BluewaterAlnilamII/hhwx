...
- mask-cover proof ledger `low-memory-polish-hhwx-2026-06-18T04-14-43-635Z.json` keeps P02 stable (`bounded`, gap `382812`, average `9376984`, max `9412868`, peak `3860 MiB`) and records replayable safe-mask entries: `maskProofLedgerCount = 153`, `maskProofLedgerImpliedAnchorCount = 367434`, `maskProofLedgerDroppedAnchorCount = 32566`. Each ledger row carries `mask`, `excludedCardIds`, `anchorCount`, `maxAnchorScore`, `pairUpper`, `totalUpper`, `incumbentScore`, `margin`, and `pairSplitStateCount`; the largest row proves `52240` anchors safe with margin `31224`. This satisfies the diagnostic-side proof-ledger shape needed before any real grouped-mask pruning attempt, but it is still post-materialization and opt-in only.
