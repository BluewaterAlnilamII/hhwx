...
a currently existing player-side minion without applying to enemies. It also
verifies CN weapon `16` / bullet `22` uses buff `11`'s minion-side attack and
bullet-size attributes when that existing minion fires its own weapon.
