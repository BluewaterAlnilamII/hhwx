...
- Current special-buff handling covers the self-buff contact subset observed on
  ...
  summon and player-side buff events. Minion heal/revive HP semantics are still
  absent because the first-pass minion model has no HP/death lifecycle. Native
  ally selection, teammate-alive invalidation, exact shooter modifier
  inheritance timing, and exact revive animation timing remain pending.
