...
Current checkpoint (2026-09-01): after the accepted fourteen-scene small-roster rerun, clean commit `8c758bf` ran all 48 authorized scenes across twelve historically four-scene-exact profiles over 1,000 cards. Against the primary references, 45 completed exact (42 equal, 3 higher). The other three—1229/event244, 1513/event244 and 1703/event260—reached the primary scores but timed out at 300 seconds, so they failed. Scoring and search were unchanged.

Native search totaled 3,606.484 seconds; sampled process peak was 40.36 MiB and budgeted search-storage peak 32.16 MiB. Five scenes also remain below higher records with missing data snapshots; their cause is unresolved. This stage is not fully accepted. [The fixture procedure](bandori-medley-fixtures.md) indexes the complete private results and preserves the final five high-pressure profiles, which were not run. No budget increase, historical-team replay, algorithm change or browser/WASM acceptance is implied.
