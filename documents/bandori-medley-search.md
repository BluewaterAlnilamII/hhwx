...
Current diagnostic checkpoint (`a0304eb`, 2026-08-31): 119 cards returned exact after 39.477 seconds, up 5,993.6 from the previous diagnostic; 961 cards still timed out at 60 seconds without meaningful score improvement. Both fail the unchanged historical-score acceptance check. The 119-card winner has exactly the archived three card sets, leaders and area configuration; its difference is concentrated in song 703, whose current score also occurs in the earlier retained Bestdori scoring audit. Do not label this a missing historical team, silently lower the acceptance threshold, or change scoring to match an old report. Private run `2026-08-31T11-06-08.470Z` retains the comparison and limits; further discrepancy work and search optimization require their own scope.
